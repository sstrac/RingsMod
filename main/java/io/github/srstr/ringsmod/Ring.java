...
public abstract class Ring extends Item {
    ...
    public Ring(Enchantment headEnchantment, Enchantment chestplateEnchatment, Enchantment leggingsEnchantment, Enchantment bootsEnchantment, Enchantment weaponEnchantment, int level) {
        ...
        this.enchantments.put(EquipmentSlotType.CHEST, chestplateEnchatment);
