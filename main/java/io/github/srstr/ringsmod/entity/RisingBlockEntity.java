...
import io.github.srstr.ringsmod.Registration;
import io.github.srstr.ringsmod.block.RisingBlock;
...
public class RisingBlockEntity extends Entity{
    ...
    protected static final DataParameter<BlockPos> ORIGIN = EntityDataManager.createKey(RisingBlockEntity.class, DataSerializers.BLOCK_POS);

    public RisingBlockEntity(EntityType<? extends Entity> type, World worldIn) {
        super(type, worldIn);
    }

    public RisingBlockEntity(World worldIn, double x, double y, double z, BlockState RisingBlockState) {
        this(Registration.RISING_BLOCK_ENTITY, worldIn);
        this.fallTile = RisingBlockState;
                ...
                if (!this.onGround && !flag1) {
                    ...
                    if (!blockstate.isIn(Blocks.MOVING_PISTON)) {
                        ...
                        if (!this.dontSetBlock) {
                            ...
                            boolean flag3 = RisingBlock.canFallThrough(this.world.getBlockState(blockpos1.down())) && (!flag || !flag1);
                            ...
                            if (flag2 && flag4) {
                                ...
                                if (this.world.setBlockState(blockpos1, this.fallTile, 3)) {
                                    if (block instanceof RisingBlock) {
                                        ((RisingBlock)block).onEndFalling(this.world, blockpos1, this.fallTile, blockstate, this);
                                    }
                            ...
                            ((RisingBlock)block).onBroken(this.world, blockpos1, this);
                        }
                    }
                }
            }
